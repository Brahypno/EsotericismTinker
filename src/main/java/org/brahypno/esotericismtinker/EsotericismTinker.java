...
import org.brahypno.esotericismtinker.common.data.tags.ModifierTagProvider;
...
public class EsotericismTinker {
    ...
    public EsotericismTinker() {
        ...
        modEventBus.register(new EsotericismTinkerTranscendenceTable());
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.SERVER, StigmataConfig.SPEC);
    ...
    public void gatherData(final GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new ModifierTagProvider(output, helper));
        ...
        generator.addProvider(event.includeServer(), new EsotericismTinkerModifierProvider(output));
        generator.addProvider(event.includeServer(), new NoumenonCostDataProvider(output));
