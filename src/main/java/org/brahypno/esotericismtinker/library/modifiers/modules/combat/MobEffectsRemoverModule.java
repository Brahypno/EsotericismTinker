...
public record MobEffectsRemoverModule(IJsonPredicate<LivingEntity> target, RandomLevelingValue level,
    ...
    @Internal
    public MobEffectsRemoverModule {
    }
    ...
    public float beforeMeleeHit(IToolStackView tool, ModifierEntry modifier, ToolAttackContext context, float damage, float baseKnockback, float knockback) {
        if (this.removeBeforeMelee && this.condition.matches(tool, modifier)){
            this.removeEffects(this.removeOwner ? context.getAttacker() : ETHelper.getLivingTarget(context.getTarget()), modifier.getEffectiveLevel());
        }
    ...
    static {
        DEFAULT_HOOKS = HookProvider.defaultHooks(
                ModifierHooks.ON_ATTACKED, ModifierHooks.MELEE_HIT, ModifierHooks.MONSTER_MELEE_HIT, ModifierHooks.PROJECTILE_HIT);
