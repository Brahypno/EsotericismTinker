package org.brahypno.esotericismtinker.smeltery.block.entity.controller;
...
import static org.brahypno.esotericismtinker.Config.transmuteAcceleratorTemperature;
import static org.brahypno.esotericismtinker.Config.transmuteHeaterTemperature;
...
public class TransmuteBlockEntity extends HeatingStructureBlockEntity {
     ...
     * GUI name
     */
    private static final Component NAME = EsotericismTinker.makeTranslation("gui", "transmute");
    /**
    ...
    public TransmuteBlockEntity(BlockPos pos, BlockState state) {
        super(EsotericismTinkerSmeltery.Transmute.get(), pos, state, NAME);
    }
    ...
    protected int getHeatTimeMultiplier() {
        return accelerator * transmuteAcceleratorTemperature;
    }
    ...
    protected boolean isHeaterBlock(Block block) {
        return block.builtInRegistryHolder().is(EsotericismTinkerTagKeys.Blocks.TRANSMUTE_HEATER);
    }

    @SuppressWarnings("deprecation")
    protected boolean isAccelBlock(Block block) {
        return block.builtInRegistryHolder().is(EsotericismTinkerTagKeys.Blocks.TRANSMUTE_ACCEL);
    }

    @SuppressWarnings("deprecation")
    protected boolean isAlloySwitchBlock(Block block) {
        return block.builtInRegistryHolder().is(EsotericismTinkerTagKeys.Blocks.TRANSMUTE_ALLOY_SWITCH);
    }

    @SuppressWarnings("deprecation")
    protected boolean isMeltSwitchBlock(Block block) {
        return block.builtInRegistryHolder().is(EsotericismTinkerTagKeys.Blocks.TRANSMUTE_MELTING_SWITCH);
    }

    public int getHeatTemperatureBuff() {
        return heater * transmuteHeaterTemperature;
    }
