 ...
 */
public record NoumenonReceptionEntry(ResourceLocation id, String slotType, int cost, int maxCount, int minLevel, NoumenonRequirement requirement, NoumenonDisplay display) {
