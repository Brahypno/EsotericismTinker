...
public record NoumenonSublimationEntry(ResourceLocation id, int costPerLevel, int maxLevel, int minLevel, NoumenonRequirement requirement, NoumenonSublimationEffect effect, NoumenonDisplay display) {
