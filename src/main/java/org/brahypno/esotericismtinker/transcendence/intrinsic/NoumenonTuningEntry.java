...
public record NoumenonTuningEntry(ResourceLocation id, int costPerLevel, int maxLevel, int minLevel, NoumenonRequirement requirement, NoumenonTuningEffect effect, NoumenonDisplay display) {
