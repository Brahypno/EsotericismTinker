...
public class NoumenonLevelRecipeBuilder extends ModifierRecipeBuilder {
    ...
    public static NoumenonLevelRecipeBuilder modifier(ModifierId modifier) {
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation id) {
        ...
        consumer.accept(new LoadableFinishedRecipe<>(
                new NoumenonLevelRecipe(id, inputs, tools, maxToolSize, result, ModifierEntry.VALID_LEVEL.range(minLevel, maxLevel), slots, allowCrystal, checkTraitLevel),
