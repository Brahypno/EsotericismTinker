...
public final class TranscendenceAnvilBlockEntityRenderer
    ...
    public TranscendenceAnvilBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        this.itemRenderer = context.getItemRenderer();
    }

    @Override
    public void render(TranscendenceAnvilBlockEntity anvil, float partialTick, PoseStack pose, MultiBufferSource buffers, int packedLight, int packedOverlay) {
        ...
        itemRenderer.renderStatic(tool, ItemDisplayContext.FIXED, getLight(anvil), packedOverlay, pose, buffers, anvil.getLevel(), (int)anvil.getBlockPos().asLong());
        pose.popPose();
    }
