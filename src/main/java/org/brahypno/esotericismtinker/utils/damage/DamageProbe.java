...
public final class DamageProbe {
     ...
     */
    public static int clearDamageGuards(@Nullable LivingEntity victim) {
        return GuardStateSupport.clearDamageGuards(victim);
    }
     ...
     * @return number of guard methods successfully invoked
     */
    public static int clearDamageGuards(
     ...
     */
    public static int cachedDamageGuardCount(@Nullable LivingEntity victim) {
        return GuardStateSupport.cachedGuardCount(victim);
    }
}
